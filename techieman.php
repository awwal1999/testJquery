...
<html lang="en">
 ...
 <form id="formSub" method="POST" action="techieman.php">
        <input id="" type="text" name="chatInput" placeholder="Write your message here..." />
            ...
            e.preventDefault();
                $.ajax({
                    ...
                    success: function(response) {
                      ...
                      alert("Thank you");
                      $('#formSub').append("<div>"+response.chatInput
                        +"</div><div>"+response.answer+"</div>")
                    },
